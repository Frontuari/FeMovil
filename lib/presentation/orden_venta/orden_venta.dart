...
class OrdenDeVentaScreen extends StatefulWidget {
  ...
  const OrdenDeVentaScreen({super.key, required this.clientId, required this.clientName, required this.cBPartnerId, required this.cBPartnerLocationId, required this.rucCbpartner});
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: mediaScreen * 0.15,),
                              ...
                              Padding(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('Ruc/DNI', style: TextStyle(fontFamily: 'Poppins Bold', fontSize: 18),),
                                    Text(widget.rucCbpartner)
                                  ],
                                ),
                              ),
