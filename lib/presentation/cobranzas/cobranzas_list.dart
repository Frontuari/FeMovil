...
void _showFilterOptions(BuildContext context) {
  ...
  showMenu(
    ...
    position: RelativeRect.fromRect(
      Rect.fromPoints(
        const Offset(20, 240), // Punto de inicio en la esquina superior izquierda
        const Offset(180, 250), // Punto de fin en la esquina superior izquierda
      ),
                        ...
                        onChanged: (value) {
                          ...
                          setState(() {
                            input = value;
                              ...
                              final numeroReferencia = venta['ruc'].toString().toLowerCase();
                                                          ...
                                                          children: [
                                                            ...
                                                            SizedBox(
                                                                width:
                                                                    screenMax *
                                                                        0.45,
                                                                child: Text('${venta['monto'].toString()}\$',
                                                                  style: const TextStyle(
                                                                      fontFamily:
                                                                          'Poppins Regular'),
                                                                  overflow:
                                                          ...
                                                          children: [
                                                            ...
                                                            SizedBox(
                                                                width:
                                                                    screenMax *
                                                                        0.40,
                                                                child: Text(venta['descripcion'].toString(),
                                                                  style: const TextStyle(
                                                                      fontFamily:
                                                                          'Poppins Regular'),
                                                                  overflow:
