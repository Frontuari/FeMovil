...
void _showFilterOptions(BuildContext context, colorPrimary, screenMax) {
  ...
  color: Colors.grey.withOpacity(0.5), // Establece el color transparente como punto inicial del gradiente
    ...
    position: RelativeRect.fromRect(
      Rect.fromPoints(
        const Offset(150, 240), // Punto de inicio en la esquina superior izquierda
        const Offset(250, 250), // Punto de fin en la esquina superior izquierda
      ),
        ...
        child: ListTile(
          title: Row(
            children: [
              ...
              const Text('Filtrar Por el monto Mayor', style: TextStyle(fontFamily: 'Poppins Regular'),),
            ],
          ),
          onTap: () {
          ...
          title: Row(
            children: [
              Image.asset('lib/assets/Check@3x.png', width: 25,
                ...
                SizedBox(width: MediaQuery.of(context).size.width *0.02,),
              const Text('Ordenar por un rango de fecha', style: TextStyle(fontFamily: 'Poppins Regular'),),
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  final nombreCliente = venta['nombre_cliente'].toString().toLowerCase();
                  final orderSale = venta['documentno'].toString();
                  return numeroReferencia.contains(input) || nombreCliente.contains(input) || orderSale.contains(input) ;
                }).toList();
                });
                    });
                  },
                                              ...
                                              children: [
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        SizedBox(
                                                          ...
                                                          child: Text('${venta['nombre_cliente']}', style: const TextStyle(fontFamily: 'Poppins Regular' ), overflow: TextOverflow.ellipsis,))
                                                      ],
                                                    ),
                                                    Row(
                                                      children: [
                                                        ...
                                                        SizedBox(
                                                          width: screenMax * 0.45,
                                                          child: Text('${venta['fecha']}', style: const TextStyle(fontFamily: 'Poppins Regular'),overflow: TextOverflow.ellipsis,)),
                                                      ],
                                                    ),
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                      width: screenMax * 0.45,
                                                      child: Text('${venta['monto'] is double ? venta['monto'] : 0}\$',style: const TextStyle(fontFamily: 'Poppins Regular'),overflow: TextOverflow.ellipsis,))
                                                  ],
                                                ),
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                      width: screenMax * 0.45,
                                                      child: Text(venta['descripcion'].toString(),style: const TextStyle(fontFamily: 'Poppins Regular'),overflow: TextOverflow.ellipsis,))
                                                  ],
                                                ),
